...
> 这个题可以算R2，一个小技巧，但是由于和生活相关，比下一道题可以稍微提一档。
...
> 这个题我第一轮（最早的一次）就评过，一个小技巧没有计算量，并且容易观察到的，到R2就差不多了
...
> 这也是我第一轮就评过的题。R3和R4之间吧。你看一下我的第一轮评价，我也忘了当时选哪一档了。
...
> 这个复杂度和计算量在R3和R4之间吧，到R4勉强，我更倾向于R3。
...
> 不拐弯的计算，量也不大，就R2。另外这一题怎么又把答案写在题干里了？必须全面审核这种给答案的提示。
