...
> 无论从思路链条还是计算量都是R3。判断R1是莫名其妙，计算量也不能是R1。
...
> R1偏上吧，算R2也行，带一点常识性的题目可以适当调高难度级。现在的学生缺乏常识。
...
> 这题从计算量上来说至少R2。因为思路稍微要绕一下，算R3中比较简单的可以。
...
> 绝对R4难度。解析出了问题，9/41怎么来的？中间跳过大量推理步骤然后说步骤数少？
...
> 这种比例题前面已有不少，思维需要转不少弯。注意这是小学题，小学生并没有太强的方程思维能力。
