...
List<Chapter> get curriculumChapters => [
  ...
  // V3.10 新增：语文按 KP 一级 category 作 chapter（spec §3.2，4 grade × 13 category = 52）
  // 真题入库时 chapter 字段直接用 KP fullPath 第一段，避免强行映射到教材单元体系
  Chapter(subject: '语文', grade: 6, orderIndex: 21, chapterName: '字词'),
  Chapter(subject: '语文', grade: 6, orderIndex: 22, chapterName: '修辞'),
  Chapter(subject: '语文', grade: 6, orderIndex: 23, chapterName: '句式与标点'),
  Chapter(subject: '语文', grade: 6, orderIndex: 24, chapterName: '写作'),
  Chapter(subject: '语文', grade: 6, orderIndex: 25, chapterName: '古诗文'),
  Chapter(subject: '语文', grade: 6, orderIndex: 26, chapterName: '文学常识'),
  Chapter(subject: '语文', grade: 6, orderIndex: 27, chapterName: '名著阅读'),
  Chapter(subject: '语文', grade: 6, orderIndex: 28, chapterName: '现代文阅读'),
  Chapter(subject: '语文', grade: 6, orderIndex: 29, chapterName: '综合性学习'),
  Chapter(subject: '语文', grade: 6, orderIndex: 30, chapterName: '语法'),
  Chapter(subject: '语文', grade: 6, orderIndex: 31, chapterName: '语法与句式'),
  Chapter(subject: '语文', grade: 6, orderIndex: 32, chapterName: '课文与名著'),
  Chapter(subject: '语文', grade: 6, orderIndex: 33, chapterName: '阅读理解'),
  Chapter(subject: '语文', grade: 7, orderIndex: 21, chapterName: '字词'),
  Chapter(subject: '语文', grade: 7, orderIndex: 22, chapterName: '修辞'),
  Chapter(subject: '语文', grade: 7, orderIndex: 23, chapterName: '句式与标点'),
  Chapter(subject: '语文', grade: 7, orderIndex: 24, chapterName: '写作'),
  Chapter(subject: '语文', grade: 7, orderIndex: 25, chapterName: '古诗文'),
  Chapter(subject: '语文', grade: 7, orderIndex: 26, chapterName: '文学常识'),
  Chapter(subject: '语文', grade: 7, orderIndex: 27, chapterName: '名著阅读'),
  Chapter(subject: '语文', grade: 7, orderIndex: 28, chapterName: '现代文阅读'),
  Chapter(subject: '语文', grade: 7, orderIndex: 29, chapterName: '综合性学习'),
  Chapter(subject: '语文', grade: 7, orderIndex: 30, chapterName: '语法'),
  Chapter(subject: '语文', grade: 7, orderIndex: 31, chapterName: '语法与句式'),
  Chapter(subject: '语文', grade: 7, orderIndex: 32, chapterName: '课文与名著'),
  Chapter(subject: '语文', grade: 7, orderIndex: 33, chapterName: '阅读理解'),
  Chapter(subject: '语文', grade: 8, orderIndex: 21, chapterName: '字词'),
  Chapter(subject: '语文', grade: 8, orderIndex: 22, chapterName: '修辞'),
  Chapter(subject: '语文', grade: 8, orderIndex: 23, chapterName: '句式与标点'),
  Chapter(subject: '语文', grade: 8, orderIndex: 24, chapterName: '写作'),
  Chapter(subject: '语文', grade: 8, orderIndex: 25, chapterName: '古诗文'),
  Chapter(subject: '语文', grade: 8, orderIndex: 26, chapterName: '文学常识'),
  Chapter(subject: '语文', grade: 8, orderIndex: 27, chapterName: '名著阅读'),
  Chapter(subject: '语文', grade: 8, orderIndex: 28, chapterName: '现代文阅读'),
  Chapter(subject: '语文', grade: 8, orderIndex: 29, chapterName: '综合性学习'),
  Chapter(subject: '语文', grade: 8, orderIndex: 30, chapterName: '语法'),
  Chapter(subject: '语文', grade: 8, orderIndex: 31, chapterName: '语法与句式'),
  Chapter(subject: '语文', grade: 8, orderIndex: 32, chapterName: '课文与名著'),
  Chapter(subject: '语文', grade: 8, orderIndex: 33, chapterName: '阅读理解'),
  Chapter(subject: '语文', grade: 9, orderIndex: 21, chapterName: '字词'),
  Chapter(subject: '语文', grade: 9, orderIndex: 22, chapterName: '修辞'),
  Chapter(subject: '语文', grade: 9, orderIndex: 23, chapterName: '句式与标点'),
  Chapter(subject: '语文', grade: 9, orderIndex: 24, chapterName: '写作'),
  Chapter(subject: '语文', grade: 9, orderIndex: 25, chapterName: '古诗文'),
  Chapter(subject: '语文', grade: 9, orderIndex: 26, chapterName: '文学常识'),
  Chapter(subject: '语文', grade: 9, orderIndex: 27, chapterName: '名著阅读'),
  Chapter(subject: '语文', grade: 9, orderIndex: 28, chapterName: '现代文阅读'),
  Chapter(subject: '语文', grade: 9, orderIndex: 29, chapterName: '综合性学习'),
  Chapter(subject: '语文', grade: 9, orderIndex: 30, chapterName: '语法'),
  Chapter(subject: '语文', grade: 9, orderIndex: 31, chapterName: '语法与句式'),
  Chapter(subject: '语文', grade: 9, orderIndex: 32, chapterName: '课文与名著'),
  Chapter(subject: '语文', grade: 9, orderIndex: 33, chapterName: '阅读理解'),
